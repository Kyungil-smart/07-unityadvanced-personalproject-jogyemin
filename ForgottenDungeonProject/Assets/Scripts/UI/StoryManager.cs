...
질척이는 진흙길을 걷던 중, 짙은 안개 너머로 낡은 성문이 모습을 드러냈다.  
지도조차 존재하지 않는 버려진 폐성.
...
그러나 다시 같은 길을 지나던 순간, 기묘한 위화감이 목덜미를 훑었다.
...
하나는 다시 궤적을 되돌리는 듯한 문,  
다른 하나는 더 깊은 심연으로 이끄는 문.
...
복도 끝 짙은 어둠 속에서 기이한 형체가 꿈틀거리며 기어 나왔다.

얼굴이 있어야 할 자리에 괴이한 책을 뒤집어쓴 괴물이  
기괴하게 뒤틀린 팔다리로 바닥을 긁고 있었다.

반대편 벽에서는 바짝 말라비틀어진 오크가  
마치 그림자처럼 소리 없이 기어 다녔다.

놈들은 아무런 소리도 내지 않았지만,  
명백한 살의로 나를 인식하고 있었다.

무심코 그들과 시선이 얽힌 순간,  
복도의 횃불이 일제히 꺼지며 던전은 완벽한 암흑 속으로 가라앉았다.",
...
기어오는 소리가 가까워질수록  
바닥을 타고 오르는 미세한 진동이 온몸을 떨게 했다.

이곳은 단순한 기억력의 시험장이 아니었다.
...
하나는 안전을 덮어쓴 함정일 것이고,  
다른 하나는 탈출로 위장한 절망일 터였다.

여덟 번을 무사히 넘기면 끝난다는  
낯선 속삭임이 이명처럼 스쳐 지나갔다.

단 한 번이라도 실패한다면  
처음의 지옥으로 돌아가거나, 영원히 저들의 먹잇감이 될 것이다.",
